...
- `Facades::PdfFileEditor` — `Concatenate`, `MakeBooklet`, `MakeNUp`, `ResizeContents`, `AddMargins`, `SplitFromFirst`/`SplitToEnd`/`SplitToPages`/`SplitToBulks`, plus `Try*` non-throwing variants
